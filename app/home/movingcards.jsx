    ...
    return (
        <div className='my-4'>
            <motion.div
                ...
                <div className='text-7xl max-sm:text-5xl font-semibold text-[#0D0741] text-center'>
                    <div >
                        <span className='relative'>
                            ...
                            <Image className='absolute -bottom-2 left-0' src={Underline} alt="" width={1000} />
                        </span>
                ...
                <div className='text-2xl dark:text-white max-sm:text-lg max-w-[50%] max-sm:max-w-[90%] text-center'>our platform allows individuals to raise funds online for projects, causes, or businesses through community contributions and support.</div>
            </motion.div>

            <div class="wrapper">
                {
                    upperlogo.map((item, index) => {
                        return <div key={index} class={`itemLeft flex items-center justify-center ${item.name}`} >
            ...
            <div class="wrapper">
                {
                    downlogo.map((item, index1) => {
                        return <div key={index1} class={`itemRight flex items-center justify-center ${item.name}`} >
                            <Image src={item.src} alt="" width={100} />
                        </div>
                    })
